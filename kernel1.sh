...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	git clone --depth 1 https://github.com/L1sa-f/AnyKernel3
...
gen_zip() {
	...
	cdir AnyKernel3
	zip -r $ZIPNAME-$DEVICE-build-$KBUILD_BUILD_VERSION . -x ".git*" -x "README.md" -x "*.zip"

	## Prepare a final zip variable
	ZIP_FINAL="$ZIPNAME-$DEVICE-build-$KBUILD_BUILD_VERSION"
